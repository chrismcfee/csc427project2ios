...
#import "DiffuseViewController.h"
#import "CubeNorm.h"

@interface DiffuseViewController ()

@end

@implementation DiffuseViewController
{
    CubeNorm *_cube;
}
...
- (void)viewDidLoad {
    ...
    [self setupVertexShader:@"SimpleDiffuseVertex.glsl" FragmentShader:@"SimpleDiffuseFragment.glsl"];
